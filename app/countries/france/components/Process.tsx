...
export default function FranceProcess() {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <header className="mb-10">
          <h2 className="text-3xl font-bold text-gray-900 border-l-4 border-purple-600 pl-4 mb-3">
            French Application & Visa Process
          </h2>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                  ...
                  <p className="text-gray-700">
                    Explore universities and courses in France. Note that most undergraduate programs are taught in French, although an increasing number of courses are available in English. Verify that your school-leaving certificate is recognized by French education authorities or via Campus France.
                  </p>
                </div>
                ...
                <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                  ...
                  <p className="text-gray-700">
                    Apply through Campus France or directly via university portals. Always check the specific requirements for each institution.
                  </p>
                </div>
                ...
                <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                  ...
                  <p className="text-gray-700">
                    For French-taught programs, provide TCF, DELF, or DALF certificates. For English-taught courses, submit IELTS or TOEFL scores as required.
                  </p>
                </div>
                ...
                <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                  ...
                  <p className="text-gray-700">
                    Write a compelling letter of motivation outlining your academic interests, career goals, and reasons for choosing France as your study destination.
                  </p>
                </div>
                ...
                <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                  ...
                  <p className="text-gray-700">
                    Review deadlines carefully. For the Fall Semester (starting in September/October), deadlines often fall between January and March. For the Spring Semester, deadlines are typically between July and September.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                  ...
                  <p className="text-gray-700">
                    Apply directly through the university’s online system or via Campus France if required.
                  </p>
                </div>
                ...
                <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                  ...
                  <p className="text-gray-700">
                    Provide proof of language proficiency: TCF, DELF, or DALF for French-taught programs, and IELTS/TOEFL for courses in English.
                  </p>
                </div>
                ...
                <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                  ...
                  <p className="text-gray-700">
                    Explore scholarships such as the Eiffel Excellence Scholarship, Erasmus+, or institution-specific funding. Note that scholarship deadlines are often earlier than program application deadlines.
                  </p>
                </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                ...
                <p className="text-gray-700">
                  Apply for a long-stay student visa (Visa de long séjour pour études) at the French consulate or embassy. The visa fee is approximately €99. It’s recommended to apply at least 2-3 months before your course begins.
                </p>
              </div>
              ...
              <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                ...
                <p className="text-gray-700">
                  Demonstrate your financial means through a bank statement or scholarship award. You must typically show proof of at least €615 per month to cover living expenses.
                </p>
              </div>
              ...
              <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                ...
                <p className="text-gray-700">
                  Obtain mandatory health insurance. Students in France must register with the French Social Security system and may also opt for supplementary private coverage.
                </p>
              </div>
              ...
              <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                ...
                <p className="text-gray-700">
                  Prepare your passport, admission letter, financial proof, language certificates, and any additional documents requested by the consulate.
                </p>
              </div>
              ...
              <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                ...
                <p className="text-gray-700">
                  Provide biometric data and attend an interview if required by French authorities.
                </p>
              </div>
              ...
              <div className="p-4 border-l-4 border-purple-400 bg-purple-50 rounded-r shadow-sm">
                ...
                <p className="text-gray-700">
                  After arrival, validate your student visa with the OFII (Office Français de l'Immigration et de l'Intégration) and complete any required registration formalities.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mb-8 overflow-hidden">
              <div className="flex flex-wrap justify-between relative mb-12">
                ...
                <div className="w-full sm:w-1/5 text-center relative z-10">
                  ...
                  <p className="mt-2 text-sm text-gray-600">Complete registration & OFII validation</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-purple-50 p-5 rounded-lg shadow-sm">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700"><strong>January-March:</strong> Deadlines for Fall Semester (September/October intake) applications</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-3 h-3 bg-purple-600 rounded-full mt-1.5 mr-2"></span>
                    <span className="text-gray-700"><strong>July-September:</strong> Deadlines for Spring Semester (January intake) applications</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-3 h-3 bg-purple-600 rounded-full mt-1.5 mr-2"></span>
              ...
              <div className="bg-purple-50 p-5 rounded-lg shadow-sm">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <span className="inline-block w-3 h-3 bg-purple-600 rounded-full mt-1.5 mr-2"></span>
                    <span className="text-gray-700">Living costs and regional accents vary between urban and rural areas</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-3 h-3 bg-purple-600 rounded-full mt-1.5 mr-2"></span>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <span className="inline-block w-3 h-3 bg-purple-600 rounded-full mt-1.5 mr-2"></span>
                      <span className="text-gray-700">Students can work up to 964 hours per year (about 60% of full-time hours) without a separate work permit</span>
                    </li>
                    <li className="flex items-start">
                      <span className="inline-block w-3 h-3 bg-purple-600 rounded-full mt-1.5 mr-2"></span>
                      <span className="text-gray-700">After graduation, eligible international graduates can apply for a temporary residence permit or job search visa for up to 12 months</span>
                    </li>
                  </ul>
                </div>
                <div>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <span className="inline-block w-3 h-3 bg-purple-600 rounded-full mt-1.5 mr-2"></span>
                      <span className="text-gray-700">International students may work part-time as per French regulations</span>
                    </li>
                    <li className="flex items-start">
                      <span className="inline-block w-3 h-3 bg-purple-600 rounded-full mt-1.5 mr-2"></span>
                      <span className="text-gray-700">Health insurance is mandatory; students must enroll in the French Social Security system or provide equivalent private coverage</span>
                    </li>
                  </ul>
                </div>
              </div>
